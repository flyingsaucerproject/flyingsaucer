...
/**
 * An ImageReplacedElement is a {@link ReplacedElement} that contains a {@link Image}. It's used as a
 * container for images included within XML being rendered. The image contained is immutable.
 */
public class InstantImageReplacedElement implements ImageReplacedElement {
     ...
     */
    public InstantImageReplacedElement(final Image image, final int targetWidth, final int targetHeight) {
