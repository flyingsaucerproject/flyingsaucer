...
public class FloatLayoutResult {
    ...
    private FloatedBlockContent _pendingContent;
    ...
    public FloatedBlockContent getPendingContent() {
        return _pendingContent;
    }

    public void setPendingContent(FloatedBlockContent pendingContent) {
