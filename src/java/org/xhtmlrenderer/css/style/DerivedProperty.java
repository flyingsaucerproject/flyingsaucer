...
public class DerivedProperty {
     ...
     * property. The following is true of the copy:
     * <ol>
     *   <li> is resolved</li>
     *   <li> computed value is same as parent's computed</li>
     *   <li> actual value</li>
     * </ol>
     * is same as parent's actual value. Any contained SAC {@link CSSValue}
     * instances are not deep-copied.
     *
     * @return   See desc
     */
    ...
    /**
     * Gets the ident attribute of the DerivedProperty object
     *
     * @param val  PARAM
 ...
 *
 * $Log$
 * Revision 1.6  2005/01/29 20:22:19  pdoubleya
