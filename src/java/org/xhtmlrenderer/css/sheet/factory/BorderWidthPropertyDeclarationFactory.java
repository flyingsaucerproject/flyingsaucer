/*
 * {{{ header & license
 * BorderWidthPropertyDeclarationFactory.java
...
/**
 * A PropertyDeclarationFactory for CSS 2 "border-width" shorthand property, instantiating
 * PropertyDeclarations; Singleton, use {@link #instance()}.
 *
 * @author   Patrick Wright
 */
public class BorderWidthPropertyDeclarationFactory extends AbstractPropertyDeclarationFactory {
    /** Singleton instance. */
    private static BorderWidthPropertyDeclarationFactory _instance;
    ...
    private BorderWidthPropertyDeclarationFactory() { }
    ...
    public static synchronized PropertyDeclarationFactory instance() {
        if ( _instance == null ) {
            _instance = new BorderWidthPropertyDeclarationFactory();
        }
        return _instance;
    }
}// end class
