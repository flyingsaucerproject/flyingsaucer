...
/**
 * A abstract class for {@link PropertyDeclarationFactory}; you can extend this
 * to create a basic PDFactory. PDFactories are expected to be Singletons, which
 * this class can't create for you; define an <code>instance()</code> method
 * that returns a PropertyDeclarationFactory in your subclass. If you
 *
...
public abstract class AbstractPropertyDeclarationFactory implements PropertyDeclarationFactory {
     ...
     * parser) into one or more {@link PropertyDeclaration} instances. Normally
     * one would expect just on {@link PropertyDeclaration} for a CSS property,
     * but shorthand declarations are resolved into many individual property
     ...
     * @return           Iterator of {@link PropertyDeclaration} for the
    ...
    /**
     * Convenience method to extract the {@link CSSValue}, priority, and
     * importance from a SAC {@link CSSStyleDeclaration}.
     *
     * @param style    The {@link org.w3c.dom.css.CSSStyleDeclaration} from
     *      which to extract the attributes.
