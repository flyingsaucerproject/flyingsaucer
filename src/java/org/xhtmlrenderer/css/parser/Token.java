...
public class Token {
    ...
    public static final int AT_RULE = 22;
    public static final int IMPORTANT_SYM = 23;
    public static final int EMS = 24;
    public static final int EXS = 25;
    ...
    public static final int ANGLE = 32;
    public static final int TIME = 33;
    public static final int FREQ = 34;
    ...
    public static final int VIRGULE = 43;
    ...
    public static final int VERTICAL_BAR = 52;
    public static final int EOF = 53;
