...
public class StyleRuleComparator implements Comparator {
   ...
   * <p>
   *
   * Implementation of Comparator.compare(), for the purpose of sorting rules in
   * determining cascade/inherit precedence. Specifically, this comparison will
   * result in instance o1 falling before o2 if</p>
   * <ul>
   *   <li> o1 derives from a stylesheet with lower precedence--e.g. user agent
   *   sheet has lower precedence than user sheet</li>
   *   <li> o1 came from the same sheet as o2, but preceded it in that sheet
   *   (sequentially)</li>
   *   <li> o1 and o2 were originally the same rule, but o2 includes one or more
   *   properties marked "important" in the rule</li> <p>
   *
   *   The idea, and first implementation of this, is from Scott Sauyet, adapted
   *   for this class by Patrick Wright.</p>
   *
   * @param o1  PARAM
   * @param o2  PARAM
