...
public class CalculatedStyle {
    ...
    private final static Logger sDbgLogger = LoggerUtil.getDebugLogger( CalculatedStyle.class );
    
    /** The parent-style we inherit from */
    private CalculatedStyle _parent;
    
    /** the matched properties at the base of this */
    net.homelinux.tobe.xhtmlrenderer.CascadedStyle _matched;
     ...
     * @param iter        PARAM
     */
    public CalculatedStyle(CalculatedStyle parent, net.homelinux.tobe.xhtmlrenderer.CascadedStyle matched) {
        this();
        _parent = parent;
        _matched = matched;
     ...
     */
    private void derive() {
        Iterator mProps = _matched.getPropertyDeclarations();
