 ...
 */
public class Document implements net.homelinux.tobe.xhtmlrenderer.AttributeResolver {
    ...
    public Document(UserAgentCallback ua, java.io.InputStream is, java.net.URI uri) {
        _ua = ua;
        _uri = uri;
